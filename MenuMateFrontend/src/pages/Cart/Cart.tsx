...
function calculateTotal(){
  ...
  <Header/>
    <div className={styles.Cart}>
      <h2 className={styles.Heading}>Your Order Details </h2>
      <span><Button text='<-' onclick={()=>GotoPage('home')}/></span>
      {cart.map((item, i) => {
        return (
      ...
      {checkout &&  <div className={styles.BtnContainer}>
        ...
        <Button text="Pay Later" onclick={() =>{ OrderNow(tableNumber, cart, paid);GotoPage('home')}} />
      </div>}
 
    {paid && <div className={styles.Recipe}>
